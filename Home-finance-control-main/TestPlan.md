...
Для работы приложение необходимо наличие устройства под управление Windows. 
...
1. Добавить список доходов/расходов
2. Удалить список доходов/расходов
3. Просмотреть список доходов/расходов
4. Построить диаграмму доходов/расходов
5. Выбор даты
...
Результаты тестирования представлены в документе [Test](https://github.com/MartiN9919/home-finance-_control/blob/main/Home-finance-control-main/TestA.md).
